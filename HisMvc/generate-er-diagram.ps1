# ============================================
# HIS DATABASE ER DIAGRAM GENERATOR
# ============================================
# Purpose: Generate Entity Relationship Diagram as Mermaid
# Usage: .\generate-er-diagram.ps1
# ============================================

Write-Host "?? Generating ER Diagram for HIS Database..." -ForegroundColor Cyan
...
# Save to file
$outputFile = "DATABASE_ER_DIAGRAM.md"
$mermaidContent | Out-File -FilePath $outputFile -Encoding UTF8

Write-Host "? ER Diagram generated successfully!" -ForegroundColor Green
Write-Host "?? File: $outputFile" -ForegroundColor Yellow
Write-Host ""
Write-Host "?? To view the diagram:" -ForegroundColor Cyan
Write-Host "   1. Open $outputFile in VS Code" -ForegroundColor White
Write-Host "   2. Install 'Markdown Preview Mermaid Support' extension" -ForegroundColor White
Write-Host "   3. Press Ctrl+Shift+V to preview" -ForegroundColor White
Write-Host ""
Write-Host "   OR upload to https://mermaid.live for online viewing" -ForegroundColor White
