...
│   └── Api/
│       └── AppointmentsApiController.cs  # Public API
│
├── Data/
...
#### **1. Clone Repository**
```bash
git clone https://github.com/your-username/HisMvc.git
cd HisMvc
```
...
```
**Giải pháp:**
- Delete database và recreate: `dotnet ef database drop -f`
